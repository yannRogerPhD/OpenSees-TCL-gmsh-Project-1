        ...
        with open(fileName, "w") as f__:
            ...
            for el in [e for e in elements_ if e["type"] == eType_]:
                ...
                # !!!!!!!!! 3D cases !!!!!!!!!
                    ...
                    PermXBrickUP = {i: permRawX[i] / (gVal_ * fMassBrickUP[i]) for i in mainSoilTags_}
                    PermYBrickUP = {i: permRawY[i] / (gVal_ * fMassBrickUP[i]) for i in mainSoilTags_}
                    PermZBrickUP = {i: permRawZ[i] / (gVal_ * fMassBrickUP[i]) for i in mainSoilTags_}
                    ...
                    alphaParamSSPbrickUP = {i: 1.0e-5 for i in mainSoilTags_}  # stabilization parameter
