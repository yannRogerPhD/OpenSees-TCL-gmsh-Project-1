...
puts "element quad  1  1 2 3 4  1.0   'PlaneStrain'     2   $press 0.0    $unitWeightX  $unitWeightY"
...
set reaction1 [nodeReaction 1 2]
...
#create the recorder
# recorder Node -file results/disp.out   -time  -node 1 2 3 4 -dof 1 2 -dT  0.01 disp
# recorder Node -file results/acce.out  -time  -node 1 2 3 4 -dof 1 2 -dT 0.01 accel
# recorder Element -ele 1 -time -file results/stress1.out -dT 0.01 material 1 stress
# recorder Element -ele 1 -time -file results/strain1.out -dT 0.01 material 1 strain
# recorder Element -ele 1 -time -file results/stress3.out -dT 0.01 material 3 stress
# recorder Element -ele 1 -time -file results/strain3.out -dT 0.01 material 3 strain
