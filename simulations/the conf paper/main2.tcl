...
source TCL-Files/model/drainageTopNodes.tcl
...
puts "Finished with elastic gravity analysis..."; puts " "
...
puts "Finished with plastic gravity analysis..."; puts " "
...
puts "Finished updating permeabilities for dynamic analysis..."; puts " "
...
remove recorders
set recDT [expr $motionDT*10]

set node1 197; set node2 174; set node3 151; set node4 105; set node5 81; set node6 57; set node7 18; set node8 15


# # create recorders
recorder Node -file results/accelRigidBaseSPConf1.out -time -dT $recDT \
        -node $node1 $node2 $node3 $node4 $node5 $node6 $node7 $node8 -dof 1 2 3 accel
recorder Node -file results/porePressureRBSPConf1.out -time -dT $recDT \
        -node 105 -dof 4 vel
...
puts "Dynamic loading created..."; puts "Dynamic loading created..."
puts "Dynamic loading created..."; puts " "
