...
recorder Node -file results/accelerationRef.out -time -dT $recDT  -node $nNodeT -dof 1 2 3 accel
recorder Node -file results/porePressureRef.out -time -dT $recDT  -node $nNodeT -dof 4 vel
